# CLAUDE.md — Instruções para IA trabalhando no Kova
...
Kova é um agente compatível com **Claude Code** + diferenciais:
...
Pergunta-guia para qualquer decisão: **"O Claude Code faria isso?"** Se sim, fazer igual. Se diverge, deve ter motivo objetivo (atomic apply, multi-provider, vision) documentado.
